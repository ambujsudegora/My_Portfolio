...
import { SiNextdotjs, SiTypescript, SiTailwindcss, SiFastapi, SiPython, SiDocker, SiMongodb, SiSalesforce, SiJavascript, SiHtml5, SiCss3, SiCplusplus, SiMysql } from 'react-icons/si';
...
export default function Skills() {
  ...
  const skills = [
    ...
    { icon: <FaCode />, name: "LWC" },
    { icon: <FaCode />, name: "Apex" },
  ...
  return (
    <section id="skills"
      ref={sectionRef}
      className="h-1/2 w-full pb-8 flex flex-col items-center justify-center relative bg-transparent text-white overflow-hidden">
